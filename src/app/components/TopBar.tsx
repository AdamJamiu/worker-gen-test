...
const TopBar = () => {
  return (
    <div className="right-3 left-2 bg-white shadow-md rounded p-3 flex justify-between items-center flex-wrap gap-4 sticky top-0 z-20">
      ...
      <div className="flex justify-start items-center gap-3 sm:gap-4 flex-wrap">
        <button className="flex justify-start items-center gap-1 font-medium">
          ...
          <p className="text-gray-500 text-xs 2xl:text-sm hidden md:block">
            Show cart
          </p>
        </button>
