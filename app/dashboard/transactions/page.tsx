    ...
    <AdminAuthWrapper>
      <div className="w-full">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 w-full mb-8 gap-7 lg:gap-5">
          <OverviewCard label="Total revenue" quantity="$25000" type="1" />
          <OverviewCard
            label="Completed transactions"
            quantity="$250"
            type="2"
          />
          <OverviewCard label="Pending transaction" quantity="10" type="3" />
          <OverviewCard label="Failed transaction" quantity="100" type="4" />
        </div>
