            ...
            <thead className="text-neutrals800 text-xs sm:text-sm md:text-base  border-b border-neutrals100 rounded-t-lg">
              <tr className="w-full">
                <th
                  ...
                  className="p-4 rounded-tl-xl font-normal"
                >
                  <p>Transaction ID</p>
                </th>
                <th className="p-4">
                ...
                <th className="p-4 font-normal text-left">Amount</th>
                <th className="p-4 font-normal">
                  <div
            ...
            <tbody>
              {transactions?.map((item, index) => (
                ...
                >
                  ...
                  <td className="p-4">
                    ${formatCurrency(item.amount) || "N/A"}
                  </td>
                  <td className="p-4 text-center">{item.currency}</td>
                    ...
                    <Menu
                      ...
                      Content={
                        <div className="w-full  flex flex-col">
                          <button
                            onClick={() => handleOpenTransDetailsModal(item)}
                            className="text-neutrals900 hover:bg-gray-100 flex justify-start items-center gap-2 text-sm md:text-base p-2 w-full rounded-md font-bricolage"
                          >
                            <BsEye />
