...
const Table = ({ onOpenModal, data }: ITable) => {
      ...
      <div className="rounded-lg">
        <div className="mb-7 w-full py-3 rounded-lg flex justify-between items-center gap-4 bg-white px-4 md:flex-nowrap flex-wrap">
          ...
          <div className="flex justify-start items-center gap-2">
            <button className="text-sm md:text-base flex justify-start items-center gap-2 text-primary border-primary border h-12 px-4 rounded-lg ease transition-all duration-200 hover:bg-primary hover:text-white">
              <GoDownload />
