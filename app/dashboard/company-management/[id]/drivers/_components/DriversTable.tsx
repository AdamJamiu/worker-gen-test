...
const DriversTable = ({ onOpenModal }: IDriversTable) => {
  ...
  // const { data: Drivers = [], isLoading } = useQuery<IUsersListResponse[]>({
  //   queryKey: ["Drivers-list"],
  //   queryFn: async () =>
  //     adminCaller.get("Drivers").then((res) => res.data?.data),
  ...
  const handleViewDriver = (id: string) => {
    navigate.push(`/dashboard/company-management/${id}/drivers/${id}`);
    setOpenMenuId(null);
  };
