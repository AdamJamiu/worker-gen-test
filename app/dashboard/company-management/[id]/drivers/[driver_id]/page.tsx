...
const Page = () => {
  ...
  const details = drivers.find((item) => item.id === params?.driver_id || 1);
  ...
  return (
    <AdminAuthWrapper>
      <CompanyDetailsWrapper
        page="Driver Overview"
        second_page="Driver details"
      >
        <main className="w-full bg-white rounded-xl p-4 sm:p-5 md:p-6 font-bricolage">
          <div className="flex justify-between flex-wrap md:flex-nowrap gap-10 md:gap-5 items-center w-full md:border border-neutrals400 rounded-xl sm:py-2 sm:px-4 md:px-5">
            <div className="flex justify-start items-center w-full gap-1 sm:gap-2 flex-nowrap">
              <Image
                src={davies}
                alt="davies"
                width={100}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 gap-7 md:gap-4 w-full">
            <OverviewCard label="Total earnings" quantity="$600" type="1" />
            <OverviewCard label="Total trips" quantity="37" type="2" />
            <OverviewCard label="Incomes" quantity="100km" type="3" />
            <OverviewCard label="Fines" quantity="$100" type="4" />
            <OverviewCard label="Incidents & accident" quantity="12" type="5" />
          </div>
          ...
          <div className="flex justify-between flex-col gap-5 items-start w-full md:border border-neutrals400 rounded-xl md:p-3 lg:p-4">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 w-full font-medium text-sm md:text-base">
              <p className="w-full col-span-1 text-neutrals500">Driver email</p>
              <p className="w-full col-span-1 text-neutrals900">
                {details?.email}
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 w-full font-medium text-sm md:text-base">
              ...
              <p className="w-full col-span-1 text-neutrals900">163H648</p>
            </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 w-full font-medium text-sm md:text-base">
              ...
              <p className="w-full col-span-1 text-neutrals900">12/04/2027</p>
            </div>
